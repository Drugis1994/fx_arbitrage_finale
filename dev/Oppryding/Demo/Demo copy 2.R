{# ============================
  ...
  Rcpp::sourceCpp(file.path(ROOT, "Demo", "DemoMotor.cpp"))
  Rcpp::sourceCpp(file.path(ROOT, "Demo", "DemoHelper.cpp"))    # ← NY (dine preselect/tri_pnl_batch m.m.)
  source(file.path(ROOT, "Demo", "Demo_Engine_Wrappers.R"))
  source(file.path(ROOT, "Demo", "DemoUtils.R"))
  source(file.path(ROOT, "R", "DS.R"))
  source(file.path(ROOT, "R", "tradingrobot copy.R"))
  ...
  .__old_opts <- options(
    arb.dry_run                        = TRUE,   # demo kjører uten faktiske ordre
    arb.topK.print                     = 15L,
